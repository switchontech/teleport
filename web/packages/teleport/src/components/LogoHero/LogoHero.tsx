...
// Kept exported for API parity — no longer consumed internally, but harmless
// to keep in case anything outside this file still references it.
...
export const LogoHero = ({
  my = '48px',
  customSrc: _customSrc,
}: {
  my?: string;
  customSrc?: string;
}) => (
  <Box my={my} style={{ display: 'flex', justifyContent: 'center' }}>
